<?php
/**
 * ELOPAY PKR - Payout: Create Withdrawal Order
 * Sends money to Easypaisa/JazzCash accounts
...
$accountNumber = isset($_GET['account_number']) ? $_GET['account_number'] : '';  // Mobile number: 03xxxxxxxxx
$name          = isset($_GET['name']) ? $_GET['name'] : '';
$bankName      = isset($_GET['bank_name']) ? $_GET['bank_name'] : 'easypaisa';  // easypaisa or jazzcash
...
if (empty($accountNumber) || empty($name)) {
    echo json_encode(['status' => false, 'message' => 'Missing required fields: account_number, name']);
    exit;
}

// === Generate Signature ===
$ifsc = '';  // Not required for PKR
