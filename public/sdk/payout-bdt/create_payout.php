<?php
/**
 * ELOPAY BDT - Payout: Create Withdrawal Order
 * Sends money to Nagad/bKash accounts
...
$accountNumber = isset($_GET['account_number']) ? $_GET['account_number'] : '';  // Mobile number: 01xxxxxxxxx
$name          = isset($_GET['name']) ? $_GET['name'] : '';
$bankName      = isset($_GET['bank_name']) ? $_GET['bank_name'] : 'nagad';  // nagad or bkash
