<?php
/**
 * ELOPAY INR - Payout Configuration
 * Gateway: ELOPAY India (Bank Transfer)
...
return [
    ...
    'NOTIFY_URL'    => 'https://yourdomain.com/elopay/payout-inr/callback.php',

    'LOG_FILE'      => __DIR__ . '/elopay_payout_inr.log',
];
