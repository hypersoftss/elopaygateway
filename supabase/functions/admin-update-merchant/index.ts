...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { merchantId, userId, action, newPassword } = await req.json();

    console.log(`Admin action: ${action} for merchant ${merchantId}`);
    ...
    console.error('Error in admin-update-merchant:', errorMessage);
    return new Response(
